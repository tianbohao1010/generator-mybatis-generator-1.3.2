...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseContext(Configuration configuration, Node node) {
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            } else if ("javaPojoGenerator".equals(childNode.getNodeName())){ //新增自动生成POJO
                parseJavaPojoGenerator(context,childNode);
            }
        }
    }
    ...
    private void parseJavaPojoGenerator(Context context, Node node) {
        JavaPojoGeneratorConfiguration javaPojoGeneratorConfiguration = new JavaPojoGeneratorConfiguration();

        context.setJavaPojoGeneratorConfiguration(javaPojoGeneratorConfiguration);
        ...
        //文件生成目标地址
        javaPojoGeneratorConfiguration.setTargetPackage(targetPackage);
        javaPojoGeneratorConfiguration.setTargetProject(targetProject);
        ...
        for(int i = 0; i < nodeList.getLength(); i++){
            ...
            if("property".equals(childNode.getNodeName())){
                parseProperty(javaPojoGeneratorConfiguration,childNode);
            }
        }
    }
