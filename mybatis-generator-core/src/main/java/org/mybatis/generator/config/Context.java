...
public class Context extends PropertyHolder {
    ...
    private JavaPojoGeneratorConfiguration javaPojoGeneratorConfiguration;
    ...
    public JavaPojoGeneratorConfiguration getJavaPojoGeneratorConfiguration() {
        return javaPojoGeneratorConfiguration;
    }
    ...
    public void validate(List<String> errors) {
        ...
        if (javaPojoGeneratorConfiguration == null) {
            errors.add(getString("ValidationError.8.1", id)); //$NON-NLS-1$
        } else {
            javaPojoGeneratorConfiguration.validate(errors, id);
        }
    ...
    public void setJavaPojoGeneratorConfiguration(
            JavaPojoGeneratorConfiguration javaPojoGeneratorConfiguration){
        this.javaPojoGeneratorConfiguration = javaPojoGeneratorConfiguration;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (javaPojoGeneratorConfiguration != null) {
            xmlElement.addElement(javaPojoGeneratorConfiguration
                    .toXmlElement());
        }
